...
public class MainActivity extends AppCompatActivity {
    ...
    mClearButton.setOnClickListener(new View.OnClickListener(){
        ...
        String curretName =mCurrentMovieName.getText().toString();
        ...
        Intent launchReviewIntent = new Intent(MainActivity.this, MovieReviewActvity.class);
        ...
        launchReviewIntent.putExtra(MovieReviewActivity.INITIAL_STAR_RATING, currentRating );
    ...
    //Start the Activity, using the Intent, and provide a request code.
        ...
        mCurrentMoviewName.setText(movieName);
